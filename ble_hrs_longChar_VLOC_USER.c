...
#include "ble_hrs_longChar_VLOC_USER.h"
#include <string.h>
                                                ...
                                                const ble_hrs_init_t * p_hrs_init)
{
    ...
    static uint8_t             encoded_initial_hrm[QUEUED_WRITE_BUFFER_SIZE];
    ...
    attr_md.write_perm = p_hrs_init->hrs_hrm_attr_md.write_perm;
		//MODIFIED
		attr_md.vloc       = BLE_GATTS_VLOC_USER;// Could also use BLE_GATTS_VLOC_STACK, but in this example we demonstrate the use of BLE_GATTS_VLOC_USER;    attr_md.rd_auth    = 0;
		//********
    attr_md.wr_auth    = 0;
    attr_md.vlen       = 1;
    ...
    attr_char_value.init_offs = 0;
		//MODIFIED
    attr_char_value.max_len   = QUEUED_WRITE_BUFFER_SIZE;//MAX_HRM_LEN;
		//********
